...
export function readActions(params: ClientAndAddress): TandaPayReader {
  ...
  return {
    ...
    getCurrentMemberCount: async () => getCurrentMemberCount({client, contractAddress: address}),
    getCurrentSubgroupCount: async () => getCurrentSubgroupCount({ client, contractAddress: address }),
    getCurrentClaimId: async () => getCurrentClaimId({ client, contractAddress: address }),
    getCurrentPeriodId: async () => getCurrentPeriodId({ client, contractAddress: address }),
    getTotalCoverageAmount: async () => getTotalCoverageAmount({ client, contractAddress: address }),
    getBasePremium: async () => getBasePremium({ client, contractAddress: address }),
    getCommunityState: async () => getCommunityState({ client, contractAddress: address }),
    getSubgroupInfo: async (args: GetSubgroupInfoParameters) => getSubgroupInfo({ client, contractAddress: address, ...args }),
    getClaimInfo: (args: GetClaimInfoParameters) => getClaimInfo({ client, contractAddress: address, ...args }),
    getClaimIdsInPeriod: (args?: GetClaimIdsInPeriodParameters) => getClaimIdsInPeriod({ client, contractAddress: address, ...args }),
    getDefectorMemberIdsInPeriod: (args?: GetDefectorMemberIdsInPeriodParameters) => getDefectorMemberIdsInPeriod({ client, contractAddress: address, ...args }),
    getMemberIdFromAddress: (args: GetMemberIdFromAddressParameters) => getMemberIdFromAddress({ client, contractAddress: address, ...args }),
    getWhitelistedClaimIdsInPeriod: (args?: GetWhitelistedClaimIdsInPeriodParameters) => getWhitelistedClaimIdsInPeriod({ client, contractAddress: address, ...args }),
    getMemberInfoFromAddress: (args: GetMemberInfoFromAddressParameters) => getMemberInfoFromAddress({ client, contractAddress: address, ...args }),
    getSecretaryAddress: async () => getSecretaryAddress({ client, contractAddress: address }),
    getPeriodInfo: (args?: GetPeriodInfoParameters) => getPeriodInfo({ client, contractAddress: address, ...args }),
    getSecretarySuccessorList: async () => getSecretarySuccessorList({ client, contractAddress: address }),
    isVoluntaryHandoverInProgress: async () => isVoluntaryHandoverInProgress({ client, contractAddress: address }),
    getVoluntaryHandoverNominee: async () => getVoluntaryHandoverNominee({ client, contractAddress: address }),
    getEmergencyHandoverNominees: async () => getEmergencyHandoverNominees({ client, contractAddress: address }),
    getMemberInfoFromId: (args: GetMemberInfoFromIdParameters) => getMemberInfoFromId({ client, contractAddress: address, ...args })
  }
}