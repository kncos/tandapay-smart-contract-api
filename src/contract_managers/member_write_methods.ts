...
export default class MemberWriteMethods<TClient extends WriteableClient> extends TandaPayWriteMethods<TClient> {
    ...
    async joinCommunity() : Promise<Hash | TransactionReceipt> {
    ...
    async approveSubgroupAssignment(approve: boolean = true) : Promise<Hash | TransactionReceipt> {
    ...
    async approveNewSubgroupMember(subgroupId: bigint, newMemberId: bigint, approve: boolean = true) : Promise<Hash | TransactionReceipt> {
    ...
    // Arguments --- none required
    async exitSubgroup() : Promise<Hash | TransactionReceipt> {
    ...
    // Arguments --- none required
    async defectFromCommunity() : Promise<Hash | TransactionReceipt> {
    ...
    // Arguments --- none required
    async payPremium(useAvailableBalance: boolean = false) : Promise<Hash | TransactionReceipt> {
    ...
    // Arguments --- none required
    async acceptSecretaryRole() : Promise<Hash | TransactionReceipt> {
    ...
    async emergencySecretaryHandoff(newSecretaryWalletAddress: Hex) : Promise<Hash | TransactionReceipt> {
    ...
    async withdrawRefund() : Promise<Hash | TransactionReceipt> {
    ...
    // Arguments --- none required
    async submitClaim() : Promise<Hash | TransactionReceipt> {
    ...
    // Arguments --- none required
    async withdrawClaimFund(forfeit: boolean = false) : Promise<Hash | TransactionReceipt> {
